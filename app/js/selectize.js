...
(function(root, factory) {
	...
	$.extend(Selectize.prototype, {
		...
		setup: function() {
			...
			console.log(self.$input.find("option:not([hidden])"))
			this.revertSettings = {
				$children : self.$input.find("option:not([hidden])"),
		...
		updateOriginalInput: function() {
			...
			if (self.$input[0].tagName.toLowerCase() === 'select') {
				...
				self.$input.find("option[selected]").prop("selected", false)
				// console.log(self.items[0])
				// console.log(self.$input.find("option[value='" + escape_html(self.items[0]) + "']"))
				self.$input.find("option[value='" + escape_html(self.items[0]) + "']").prop("selected", true)
			} else {
		...
		destroy: function() {
			...
			self.$input
				// .html('')
				// .append(revertSettings.$children("option:not([hidden])"))
				.removeAttr('tabindex')
